...
describe('Calc', function () {
  ...
  describe('Custom', function () {
    ...
    custom.number1 = $('.Custom .btn[data-name="number1"]');
    custom.number2 = $('.Custom .btn[data-name="number2"]');
    custom.number3 = $('.Custom .btn[data-name="number3"]');
    custom.number4 = $('.Custom .btn[data-name="number4"]');
    custom.number5 = $('.Custom .btn[data-name="number5"]');
    custom.number6 = $('.Custom .btn[data-name="number6"]');
    custom.number7 = $('.Custom .btn[data-name="number7"]');
    custom.number8 = $('.Custom .btn[data-name="number8"]');
    custom.number9 = $('.Custom .btn[data-name="number9"]');
    custom.number0 = $('.Custom .btn[data-name="number0"]');
    custom.dot = $('.Custom .btn[data-name="dot"]');
    custom.addition = $('.Custom .btn[data-name="addition"]');
    custom.subtraction = $('.Custom .btn[data-name="subtraction"]');
    custom.multiplication = $('.Custom .btn[data-name="multiplication"]');
    custom.division = $('.Custom .btn[data-name="division"]');
    custom.parenthesisOpen = $('.Custom .btn[data-name="parenthesisOpen"]');
    custom.parenthesisClose = $('.Custom .btn[data-name="parenthesisClose"]');
    custom.equality = $('.Custom .btn[data-name="equality"]');
    custom.delete = $('.Custom .btn[data-name="delete"]');
    custom.clear = $('.Custom .btn[data-name="clear"]');
    custom.memoryAdd = $('.Custom .btn[data-name="madd"]');
    custom.memorySubtract = $('.Custom .btn[data-name="msubtract"]');
    custom.memoryClear = $('.Custom .btn[data-name="mclear"]');
    custom.memoryRecall = $('.Custom .btn[data-name="mrecall"]');
    custom.percentage = $('.Custom .btn[data-name="percentage"]');
    custom.power = $('.Custom .btn[data-name="power"]');
    custom.sqrt = $('.Custom .btn[data-name="sqrt"]');
    custom.pi = $('.Custom .btn[data-name="pi"]');
    ...
    describe('Rules to insert multiplication', function () {
      ...
      // TODO this test must be investigated
