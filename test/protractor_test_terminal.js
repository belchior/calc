describe ('Calc', function () {
  ...
  describe('Terminal', function () {
    ...
    terminal.addition = $('.calc-terminal .operator[data-name=addition]');
    terminal.subtraction = $('.calc-terminal .operator[data-name=subtraction]');
    terminal.multiplication = $('.calc-terminal .operator[data-name=multiplication]');
    terminal.division = $('.calc-terminal .operator[data-name=division]');
    terminal.equality = $('.calc-terminal .operator[data-name=equality]');
    terminal.number0 = $('.calc-terminal .number[data-name=number0]');
    terminal.number1 = $('.calc-terminal .number[data-name=number1]');
    terminal.number2 = $('.calc-terminal .number[data-name=number2]');
    terminal.number3 = $('.calc-terminal .number[data-name=number3]');
    terminal.number4 = $('.calc-terminal .number[data-name=number4]');
    terminal.number5 = $('.calc-terminal .number[data-name=number5]');
    terminal.number6 = $('.calc-terminal .number[data-name=number6]');
    terminal.number7 = $('.calc-terminal .number[data-name=number7]');
    terminal.number8 = $('.calc-terminal .number[data-name=number8]');
    terminal.number9 = $('.calc-terminal .number[data-name=number9]');
    ...
    terminal.backspace = $('.calc-terminal .btn[data-name=backspace]');
    terminal.parenthesisOpen = $('.calc-terminal .bracket[data-name=parenthesisOpen]');
    terminal.parenthesisClose = $('.calc-terminal .bracket[data-name=parenthesisClose]');
